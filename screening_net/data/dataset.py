...
from .spatial_transforms import (
    Compose, Normalize, Scale, CenterCrop, CornerCrop, MultiScaleCornerCrop, MyRandomRotation,
    MultiScaleRandomCrop, RandomHorizontalFlip, ToTensor, RandomCrop, RandomCropVid, MyRandomHorizontalFlip)

from .dataset_train import bdd_vgl
from .dataset_test import bdd_vgl_gallery, bdd_vgl_test
import torch
...
def set_loader_gallery(opt):
    # construct data loader for larger aerial
...
def set_loader(opt):
    # construct data loader for large aerial images and video= seq of small aerial
    
    train_transform_video = Compose([
        RandomCrop(size=(opt.video_size_w, opt.video_size_w)),
